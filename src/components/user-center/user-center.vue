<template>
  <transition name="slide">
    <div class="user-center">
      ...
      <div class="list-wrapper" ref="listWrapper">
        <scroll ref="favoriteList" class="list-scroll" :data="favoriteList" v-if="currentIndex===0">
          <div class="list-inner">
            <song-list @showConfirm="showConfirm" :showLike="showLike" :songs="favoriteList" @select="selectItem"></song-list>
          </div>
        </scroll>
      ...
      <confirm class="confirm" @confirm="deleteOne" ref="confirm" text="您确定从喜欢列表中删除该歌曲？"></confirm>
    </div>
  </transition>
</template>
...
export default {
  ...
  methods: {
    ...
    deleteOne() {
      this.deleteFavoriteSong(this.loveSong)
    },
    // 随机播放全部歌曲
    random() {
